...
$query = "SELECT * FROM assets WHERE status='In-Stock'";

$status_result = mysqli_query($con, $query);

 ?>
<!DOCTYPE html>
<html>
<head>
	<title>Available Assets - AssetMopau</title>
...
<div class="listcont">
<div class="listtitle">
<h3><i class="fas fa-list"></i><small> List of Available Assets</small></h3>
</div><br>
<div class="listinfo"> 
	<p><strong>In this section you can see all the assets that are In-Stock.</strong></p>
	</div>
	<br><br><br>
<div class="listtbl">
