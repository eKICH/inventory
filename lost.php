...
$query = "SELECT * FROM assets WHERE status='Lost/Missing'";
...
<html>
<head>
	<title>Lost/Missing Assets - AssetMopau</title>
...
<div class="listcont">
<div class="listtitle">
<h3><i class="fas fa-list"></i><small> List of Lost/Missing Assets</small></h3>
</div><br>
<div class="listinfo"> 
	<p><strong>In this section you can see all the Lost/Missing Assets.</strong></p>
	</div>
	<br><br><br>
<div class="listtbl">
