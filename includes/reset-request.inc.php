...
if (isset($_POST['reset-request-submit'])) {
  ...
  $url = "localhost/inventory/forgotpassword.php?selector=". $selector . "&validator=". bin2hex($token);
...
try {
  ...
  //  $mail->SMTPDebug = SMTP::DEBUG_SERVER;                            // Enable verbose debug output
    ...
    $mail->Username   = 'hardcoder254@gmail.com';            // SMTP username
    $mail->Password   = 'Jesuss@29';                           // SMTP password
    $mail->SMTPSecure = "TLS";                                      // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 587;                                     // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

    //Recipients
    $mail->setFrom('hardcoder254@gmail.com', 'AssetMopau');
