...
$query = "SELECT * FROM assets WHERE status='Under Repair'";
...
<html>
<head>
	<title>Under Repair Assets - AssetMopau</title>
...
<div class="listcont">
<div class="listtitle">
<h3><i class="fas fa-list"></i><small> List of Under Repair Assets</small></h3>
</div><br>
<div class="listinfo"> 
	<p><strong>In this section you can see all the assets that are Under Repair.</strong></p>
	</div>
	<br><br><br>
<div class="listtbl">
