...
<div class="listcont">
<div class="listtitle">
<h3><i class="fas fa-list"></i><small> List of Assets</small></h3>
</div><br>
<div class="listinfo"> 
	<p><strong>Manage the assets you want in the database. After you add an asset, you can assign to employees.</strong></p>
	</div>
	<br><br><br>
<div class="listtbl">
...
<form method="POST" action="exportasset.php">

<input type="submit" class="btn btn-danger" name="exportasset" value="Export to CSV File"/>
